...
public interface ExpenseReportController {
  ...
  @Operation(
          ...
          responses = {
                  @ApiResponse(
                          description = "Ok",
                          responseCode = "200",
                          content = @Content(schema = @Schema(implementation = ExpenseGroupedByCategoryDTO.class))
                  )
          }
  )
  ...
  @Operation(
          summary = "Gets a report of all expenses grouped by category one category by passing a category name",
  ...
  @Operation(
          ...
          responses = {
                  @ApiResponse(
                          description = "Ok",
                          responseCode = "200",
                          content = @Content(schema = @Schema(implementation = ExpenseGroupedBySupplierDTO.class))
                  )
          }
  )
  ...
  @Operation(
          summary = "Gets a report of all expenses grouped by supplier one supplier by passing a supplier name",
